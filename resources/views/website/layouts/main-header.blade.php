        ...
        <div class="inner-container">
            <div class="auto-container clearfix">
                ...
                <div class="logo-outer">
                    <div class="logo"><a href="index.html"><img src="{{asset('Site/images/logo.png')}}" alt="" title=""></a></div>
                </div>
    ...
    <div class="sticky-header">
        <div class="auto-container clearfix">
            ...
            <div class="logo pull-left">
                <a href="index.html" class="img-responsive"><img src="{{asset('Site/images/logo-small.png')}}" alt="" title=""></a>
            </div>
